 ...
 * @author Alex
 */
public class BajasProfesorHelper implements Serializable{
    
    public boolean bajaProfe(Profesor profe) {
        return ServiceFacadeLocator.getInstanceFacadeProfesor().borrarProfesor(profe);
    }
