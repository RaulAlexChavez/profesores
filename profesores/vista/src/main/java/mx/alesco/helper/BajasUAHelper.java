 ...
 * @author Alex
 */
public class BajasUAHelper implements Serializable{
    
    public boolean bajaUA(UnidadDeAprendizaje ua) {
        return ServiceFacadeLocator.getInstanceFacadeUnidadDeAprendizaje().borrarUnidadDeAprendizaje(ua);
    }
